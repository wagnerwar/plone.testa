...
#
#  $ bin/test -s prodam.testa -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src prodam.testa.testing.PRODAM_TESTA_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/prodam/testa/tests/robot/test_example.robot
#
